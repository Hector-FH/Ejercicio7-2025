        ...
        while (flag) {
            ...
            switch (opcion) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    ejecutable = org.sanchez.vista.Consola.getInstance();
                    break;
                case 5:
                    ejecutable = org.sanchez.vista.Ventana.getInstance();
                    break;
                case 6:
                    ejecutable = org.flohh.vista.Consola.getInstance();
                    break;
                case 7:
                    ejecutable = org.flohh.vista.Ventana.getInstance();
                    break;
                case 8:
                    flag = false;
                    break;
